  ...
  return (
    <div className="bg-gradient-to-br from-[#394F68] to-[#18387E] text-white p-10">
        <div className="pb-5">
           ...
           <p className="text-xs text-gray-400">Lat/Lat: {lat}, {long}</p>
        </div>
        <CityPicker />
        <hr className="my-10"/>
        <div className="mt-5 flex items-center justify-between space-x-10 mb-5">
            ...
            <p className="text-xl font-bold upppercase">
        ...
        <div>
            <div className="flex items-center justify-between">
                ...
                // src={`https://www.weatherbit.io/static/img/icons/t04d.png`}
                // alt="label"
                width={75}
                height={75}
                />
          ...
          <div className="space-y-2 py-5">
            ...
            <div className="flex items-center space-x-4 px-4 py-3 border border-[#6f90CD] rounded-md bg-[#405885]">
